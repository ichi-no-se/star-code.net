...
const TriangleRender = forwardRef<TriangleRenderRef, Props>(
    function TriangleRender(props, ref) {
        ...
        const render = useCallback((ctx: CanvasRenderingContext2D) => {
            ...
            const calcSrcPos = (x: number, y: number) => {
                ...
                const srcX = p0.x + distFromPoint[0] * (cosTheta * e01.x + sinTheta * e01_perp.x);
                const srcY = p0.y + distFromPoint[0] * (cosTheta * e01.y + sinTheta * e01_perp.y);
