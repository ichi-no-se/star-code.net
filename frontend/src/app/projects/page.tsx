			...
			<ol className="post-list">
				...
				<Link href="/projects/japan-split-population-lasso" className="post-box">
					<div>
						...
						<p className="post-description">日本を投げ縄選択で分割した時のそれぞれの人口を計算．</p>
					</div>
				</Link>
				...
				<Link href="/projects/kanji-guess" className="post-box">
					<div>
						...
						<p className="post-date">2026-04-15</p>
						<p className="post-description">類似度の順位から漢字を当てるゲーム</p>
					</div>
				</Link>
				<Link href="/projects/qr-canvas" className="post-box">
					<div>
						...
						<p className="post-description">QRコードを書き換えた時にどんな影響があるか実験</p>
